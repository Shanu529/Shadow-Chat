    ...
    <>
      <nav className="w-full border-b border-gray-800 bg-[#0d0d1a]/80 backdrop-blur-md sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <div
          onClick={()=>logout()}
            className="hidden md:block cursor-pointer bg-blue-400 px-4 py-1.5 rounded-full text-xs font-semibold text-white"
          >
            Logout
          </div>
      ...
      >
        ...
        <div className="flex flex-col gap-4 px-4 py-6 text-gray-300">
          ...
          <Link
            href="/"
            onClick={() => setOpen(false)}
            className="mt-4 bg-blue-500 hover:bg-blue-600 px-4 py-2 rounded-full text-xs font-semibold text-white text-center"
          >
            Start Chat
          </Link>
          ...
          <div
            onClick={() => logout()}
            className="bg-blue-500 hover:bg-blue-600 px-4 py-2 rounded-full text-xs font-semibold text-white text-center"
          >
            Logout
          </div>
        </div>
